...
},{"./pages/auth":8,"./pages/home":9,"./pages/write":10,"vue":3}],5:[function(require,module,exports){
'use strict';
...
var mainPanel = _vue2.default.component('main-panel', {
  props: [],
  template: template,
  data: function data() {
    return _data;
...
},{"../components/main-panel":5,"../components/nav-bar":6,"../components/side-bar":7,"vue":3}],10:[function(require,module,exports){
'use strict';
...
$(document).ready(function () {
  var editor = new _mediumEditor2.default('.editor', {
    placeholder: {
      text: 'Click to edit',
      hideOnClick: true
    },
...
exports.default = _vue2.default.component('write-page', {
  props: [],
  template: template
});

},{"../components/nav-bar":6,"medium-editor":1,"vue":3}]},{},[4]);
